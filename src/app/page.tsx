        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">연락처 동기화</h3>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">네트워크 시각화</h3>
              <p className="text-gray-600 dark:text-gray-300">
                내 인맥을 한눈에 이해할 수 있는 네트워크 맵을 제공합니다
              </p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">그룹별 Insight 분석</h3>
              <p className="text-gray-600 dark:text-gray-300">
                학교/회사/취미 등 그룹별로 인사이트와 추천을 확인합니다
              </p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">신뢰 기반 소개</h3>
              <p className="text-gray-600 dark:text-gray-300">각 단계마다 동의를 받아 신뢰를 유지하며 연결합니다</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <SignedOut>
        <section className="py-20 bg-blue-600 dark:bg-blue-800">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">당신의 네트워크에 숨어있는 기회를 발견하세요</p>
            <SignInButton mode="modal">
