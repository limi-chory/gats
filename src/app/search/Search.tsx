...
export const Search = () => {
  ...
  useEffect(() => {
    ...
    if (urlQuery) {
      ...
      // 자동으로 검색 실행
      setTimeout(() => {
        handleSearchWithQuery(decodeURIComponent(urlQuery));
      }, 100);
    }
  }, [searchParams]);
      ...
      <div className="bg-white dark:bg-gray-800 border-b dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">AI 연결 검색 🔍</h1>
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 mb-8">
          <div className="text-center mb-6">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">누구를 만나고 싶으세요?</h2>
        ...
        {isSearching && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400">네트워크를 분석하고 있습니다...</p>
          </div>
        )}
        ...
        {!isSearching && results.length > 0 && (
          <div className="space-y-4">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-sm text-gray-500 dark:text-gray-400">신뢰도 높은 순</div>
            </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="text-xl font-bold text-gray-900 dark:text-white">{result.targetName}</h4>
                        <p className="text-gray-600 dark:text-gray-400">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-xs text-gray-500 dark:text-gray-400">{result.pathLength}촌</div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 mb-4">
                    <p className="text-xs font-semibold text-gray-600 dark:text-gray-400 mb-3">연결 경로:</p>
                      ...
                      {result.path.map((node, idx) => (
                        <div key={idx} className="flex items-center gap-2 flex-shrink-0">
                          <div className="text-center">
                            ...
                            <p className="text-xs font-medium text-gray-900 dark:text-white mt-1">{node.name}</p>
                            {node.relation && (
                              <p className="text-xs text-gray-500 dark:text-gray-400">{node.relation}</p>
                            )}
                          </div>
                          {idx < result.path.length - 1 && (
                            <svg
          ...
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6">
            ...
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>회사 이름:</strong> &ldquo;네이버&rdquo;, &ldquo;구글&rdquo;, &ldquo;카카오&rdquo;
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-600 dark:text-blue-400">✓</span>
                <span>
                  <strong>직무:</strong> &ldquo;개발자&rdquo;, &ldquo;디자이너&rdquo;, &ldquo;PM&rdquo;
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-600 dark:text-blue-400">✓</span>
                <span>
                  <strong>조합:</strong> &ldquo;토스 다니는 프로덕트 매니저&rdquo;
                </span>
              </li>
            </ul>
